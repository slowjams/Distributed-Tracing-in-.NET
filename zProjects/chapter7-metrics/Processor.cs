...
# HELP processor_lag_milliseconds Time items spend in queue
# TYPE processor_lag_milliseconds histogram
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="0"} 0
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="5"} 1
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="10"} 6
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="25"} 13
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="50"} 14
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="75"} 18
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="100"} 22
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="250"} 37
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="500"} 75
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="750"} 183
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="1000"} 299
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="2500"} 536
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="5000"} 1076
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="7500"} 1603
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="10000"} 1603
processor_lag_milliseconds_bucket{job="metrics",queue="add",le="+Inf"} 1603
processor_lag_milliseconds_sum{job="metrics",queue="add"} 5.7290066496e+06
processor_lag_milliseconds_count{job="metrics",queue="add"} 1603
processor_lag_milliseconds_bucket{job="metrics",queue="remove",le="0"} 0
processor_lag_milliseconds_bucket{job="metrics",queue="remove",le="5"} 242
...
