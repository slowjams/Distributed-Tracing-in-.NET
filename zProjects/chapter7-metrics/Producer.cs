...
queue_enqueued_count_total{job="metrics",queue="add"} 1727
queue_enqueued_count_total{job="metrics",queue="remove"} 1727
queue_enqueued_count_total{job="metrics",queue="update"} 1727
